...
equal-weight basket of them returned **-9%** through the GFC against REM's **-52%** — the
ones that failed are the ones no longer listed. Kept, the entry would alone have held the
shared window at 2008-07 for every other row.
...
## Why it was kept (until 2026-09-23)
