...
- **`VAA_G12` now holds `VWO` and `VNQ`, and held `EEM` and `IYR` until 2026-07-29.**
  ...
  **The switch made the strategy look WORSE, which is the useful part.** Over 2015-01…2024-12
  ...
  the binding `HYG` (2007-04), and the measured window stayed 2008-06…2026-06. (Since
  2026-09-23 the era opens 2000-01 and every ticker here is carried back on a donor.)
