...
CONFIG = {
    ...
    # Drawn from the cache as it stands, like `tools/backtest_driver`: an image regenerated for
    # the README must not also be the run that re-downloads the data behind every other figure.
    'CACHE_REFRESH_HOURS': 24.0 * 365,
}
